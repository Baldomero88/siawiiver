...
<form action="ProvedorRegistro.php" method="post">
	<input type="text" name="sNombreCompañia" placeholder="sNombreCompañia">
	<input type="text" name="sNombreContactoCompañia" placeholder="sNombreContactoCompañia">
	<input type="text" name="sDireccionCompañia" placeholder="sDireccionCompañia">
	...
	<input type="text" name="sTelefonoCompañia" placeholder="sTelefonoCompañia">
